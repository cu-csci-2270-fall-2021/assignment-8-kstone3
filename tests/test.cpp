...
TEST_F(test_x, test_CC){
    ...
    string edges[] = {"ATLS-->EC", "ATLS-->AERO", "CHEM-->DUAN", "AERO-->CHEM"};
    int elen = 4;
    result = test_CC(names,len, edges, elen);
    ...
    int elen1 = 6;
    result = test_CC(names1,len1, edges1, elen1);
    ...
    string names3[] = {"ATLS", "EC", "AERO", "CHEM", "DUAN", "FLMG", "HLMS", "UMC", "REC"};
    int len3 = 9;
    string edges3[] = {"ATLS-->AERO", "EC-->AERO", "ATLS-->DUAN", "HLMS-->UMC", "UMC-->REC"};
    int elen3 = 5;
    result = test_CC(names3,len3, edges3, elen3);
